...
This module provides multi-tier strategies for parsing JSON that may be
malformed due to LLM output issues (unescaped newlines, HTML entities, etc.).
"""
...
def handle_http_errors(
    ...
    @param adapter_name: Name of the adapter for logging
...
async def check_tool_call_parse_errors_and_retry(
    ...
    @param fallback_func: Async function to call for retry
